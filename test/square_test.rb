...
class SquareTest < Minitest::Test
  ...
  def test_it_has_spots
    row = Square.new([Spot.new(0), Spot.new(0), Spot.new(2), Spot.new(7), Spot.new(0), Spot.new(1), Spot.new(9), Spot.new(0), Spot.new(0)])
  ...
  def test_it_can_assess_itself
    row = Square.new([Spot.new(0), Spot.new(2), Spot.new(3), Spot.new(4), Spot.new(5), Spot.new(6), Spot.new(7), Spot.new(8), Spot.new(9)])
    row.assess_square
